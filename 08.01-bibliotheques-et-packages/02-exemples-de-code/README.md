# Bibliothèques et packages - Exemples de code
...
recourir à de l'aide externe (intelligence artificielle, forums, etc.) dans un
premier temps. Si vous êtes bloqué, n'hésitez pas à poser des questions en cours
ou par mail.
