...
public class Main {
     ...
     */
    private static double calculateTotalValue(int[] quantities, double[] prices) {
        double total = 0;
     ...
     */
    private static int findProduct(String[] names, String productName) {
        for (int i = 0; i < names.length; i++) {
     ...
     */
    private static void updateQuantity(String[] names, int[] quantities,
     ...
     */
    private static void displayLowStock(String[] names, int[] quantities, int threshold) {
        boolean found = false;
        for (int i = 0; i < names.length; i++) {
