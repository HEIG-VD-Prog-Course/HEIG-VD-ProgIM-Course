# Algorithmes de parcours - Exemples de code
...
- Supports de cours : [Lien vers le contenu](../01-supports-de-cours/README.md)
  ·
  [Presentation (web)](https://heig-vd-progim1-course.github.io/heig-vd-progim1-course/09.01-algorithmes-de-parcours/01-supports-de-cours/index.html)
  ·
  [Presentation (PDF)](https://heig-vd-progim1-course.github.io/heig-vd-progim1-course/09.01-algorithmes-de-parcours/01-supports-de-cours/09.01-algorithmes-de-parcours-presentation.pdf)
...
recourir à de l'aide externe (IA, forums, etc.)**.
